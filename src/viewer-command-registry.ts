...
export const VIEWER_COMMANDS: readonly ViewerCommandDefinition[] = [
  ...
  { id: "edit.cancel", keys: ["Esc"], label: { zh: "取消当前变换或选择", en: "Cancel current transform or selection" }, group: { zh: "场景编辑", en: "Scene editing" }, contexts: ["object_edit"] },
  { id: "edit.exit", keys: ["Esc"], label: { zh: "无活动选择时退出地物编辑", en: "Exit object editing when nothing is selected" }, group: { zh: "场景编辑", en: "Scene editing" }, contexts: ["object_edit"] },

...
const TRANSLATIONS: Record<string, Translation> = {
  ...
  "professional.assets.currentManifest": { en: "Use the current checked asset manifest", zh: "使用当前已检查的资产清单" },
  "professional.assets.currentManifestHint": { en: "Use scene-eligible trees and street furniture from the professional asset library.", zh: "使用专业资产库中允许参与生成的树木与街道设施。" },
  ...
  "professional.assets.useManifest": { en: "Use this manifest for generation", zh: "使用此清单参与生成" },
  "professional.assets.useManifestHint": { en: "Select and inspect a manifest, then confirm it as the 3D preparation branch.", zh: "选择并检查资产清单，然后确认完成 3D 素材准备支路。" },
  "professional.assets.manifestReady": { en: "Asset manifest ready for generation", zh: "资产清单已准备参与生成" },

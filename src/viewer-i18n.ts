...
const TRANSLATIONS: Record<string, Translation> = {
  ...
  "viewer.stage.generateLoad": { en: "New generation…", zh: "新建生成…" },
  ...
  "viewer.generationDialog.outputRevision": { en: "Create a new scene result and load it into the 3D Viewer without overwriting the current scene", zh: "创建新的场景结果并载入 3D 查看器，不覆盖当前场景" },

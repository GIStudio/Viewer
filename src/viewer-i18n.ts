...
const TRANSLATIONS: Record<string, Translation> = {
  ...
  "viewer.minimap.openPlan": { en: "Open plan map", zh: "打开平面图" },
  ...
  "professional.review.changes": { en: "Needs scene changes", zh: "需要修改场景" },
  "professional.review.annotation": { en: "Return to 2D annotation", zh: "返回 2D 标注" },
  "professional.review.assetEditor": { en: "Open all scene assets", zh: "打开全部场景资产" },
  "professional.review.note": { en: "Road and topology changes belong in 2D annotation. Asset placement changes belong in scene editing.", zh: "道路和拓扑返回 2D 标注；素材布置问题留在场景编辑。" },

...
const METRIC_OVERLAYS: Array<{ key: ExpandedMapMetricKey; en: string; zh: string }> = [
...
function comparisonTagsForManifest(
  manifest: ViewerManifest,
  text: (en: string, zh: string) => string,

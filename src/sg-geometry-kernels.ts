...
export type CornerFilletKernelTs = {
...
export function cornerQuadrantFilletTurnRadiusPx(
...
export function carriagewayEnvelopeFromBoundariesTs(
...
export function buildRoadPenStyleCrossCornerOverlayTs(
  junctionId: string,
...
export function appendStraightVehicleLaneConnectorsTs(
  junctionId: string,
  orderedArms: DerivedJunctionOverlayArm[],
  pixelsPerMeter: number,
  connectorCenterLines: DerivedJunctionOverlayConnectorLine[],
...
export function orderedCornerOffsetsTs(
  boundaryCenter: AnnotationPoint,
  normal: AnnotationPoint,
  cornerCenter: AnnotationPoint,
  innerOffsetPx: number,
...
export function polylineToBezierTs(points: AnnotationPoint[]): BezierCurve3 {

...
export const VIEWER_LANGUAGE_STORAGE_KEY = "viewer-lang";
...
export const TRANSLATIONS: Record<string, Translation> = {
  ...
  "viewer.shortcuts.capture": { en: "Drag the scene with the left mouse button to look around", zh: "按住鼠标左键拖动场景以调整视角" },
  "viewer.shortcuts.move": { en: "WASD to move, Shift to sprint, R to reset", zh: "WASD 移动，Shift 冲刺，R 重置视角" },
  ...
  "sceneGraph.source.description": {
    ...
    zh: "在主舞台自由浏览 OSM；使用当前视野或精确框选后，道路、建筑、土地利用、树木和 POI 将进入同一个统一标注方案。",
  },
  ...
  "sceneGraph.osmProgress.requesting": { en: "Requesting map data (attempt {attempt}/{max}).", zh: "正在请求地图数据（第 {attempt}/{max} 次）…" },
  ...
  "sceneGraph.review.backToArea": { en: "← Choose another study area", zh: "← 重新选择研究区" },
  ...
  "sceneGraph.review.openAnnotationTools": { en: "Open annotation tools", zh: "前往专业工具 · 标记" },
  "sceneGraph.review.openAnnotationToolsHint": { en: "Open Professional tools · Annotation to supplement or edit the imported OSM data.", zh: "打开专业工具 · 标记，补充或编辑已导入的 OSM 地图数据。" },
  "sceneGraph.review.osmBaseAnnotation": { en: "OSM map data is already a base annotation. Use Professional tools · Annotation to add or refine details.", zh: "OSM 地图数据已作为基础标注导入；可通过专业工具 · 标记继续补充或调整细节。" },
  ...
  "professional.review.accept": { en: "Accept result and browse 3D scene", zh: "接受结果并开始浏览 3D 场景" },
  ...
  "viewer.settings.buildingOpacity": { en: "Building Opacity", zh: "建筑不透明度" },
  "viewer.settings.buildingOpacityHint": { en: "Controls building visibility in the viewer only; it does not modify the scene or exported data.", zh: "仅调整查看器中的建筑显示，不修改场景数据或导出结果。" },
  ...
  "viewer.settings.weatherIntensity": { en: "Weather Effect Strength", zh: "天气效果强度" },
  "viewer.settings.weatherIntensityHint": { en: "Controls how pronounced overcast, rain, or fog appears. Clear weather stays at 0.", zh: "控制阴天、雨天或雾天效果的明显程度；晴天固定为 0。" },
  "viewer.settings.simulatedTime": { en: "Simulated Time", zh: "模拟时间" },
  "viewer.settings.simulatedTimeHint": { en: "Controls the simulated sun position and shadow direction, from 0 to 24 hours.", zh: "控制模拟太阳的位置与阴影方向，范围为 0–24 时。" },
  ...
  "viewer.hints.capture": { en: "Drag with the left mouse button to look around, then use WASD to move.", zh: "按住鼠标左键拖动调整视角，然后用 WASD 移动。" },
  "viewer.hints.move": {
    en: "Shift accelerates movement, and R resets the roam state.",
    zh: "Shift 加速，R 重置漫游状态。",
  },
  "viewer.hints.tools": {
  ...
  "sceneGraph.status.graphPlaceholder": { en: "Road structure updates automatically after annotation edits.", zh: "道路结构会在标注修改后自动更新。" },
  ...
  "viewer.overlay.capture": { en: "Overview: click to roam · Drag with left mouse button to look around", zh: "俯瞰时点击场景即可漫游；按住鼠标左键拖动调整视角" },
  ...
  "sceneGraph.right.retryGraph": { en: "Retry road structure processing", zh: "重新处理道路结构" },
  "sceneGraph.right.downloadGraph": { en: "Download Graph", zh: "下载 Graph" },
  "sceneGraph.right.downloadRoadGraph": { en: "Download road structure data", zh: "下载道路结构数据" },
  "sceneGraph.right.graphConversion": { en: "Road structure processing", zh: "道路结构处理" },
